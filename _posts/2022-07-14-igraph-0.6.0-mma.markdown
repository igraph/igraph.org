...
As always, you can update to the latest version by evaluating

```
Get["https://raw.githubusercontent.com/szhorvat/IGraphM/master/IGInstaller.m"]
```

The minimum required version of Mathematica is now 11.0, or 12.2 on the Raspberry Pi.

Please report any issues you may find at https://github.com/szhorvat/IGraphM/issues/new/choose or on our forum at https://igraph.discourse.group/
